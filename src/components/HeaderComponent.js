...
import { Navbar,Nav,Collapse, NavbarBrand, Jumbotron, NavItem, NavbarToggler, Modal, ModalHeader, ModalBody, Button, Form, FormGroup, Label, Input } from 'reactstrap';
...
class Header extends Component {
    ...
    handleLogin(event){
        ...
        alert("Username: " + this.username.value + "password: " +
         this.password.value + "remember: " + this.checkbox.checked);
